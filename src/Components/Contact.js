import ReacdatetimeclassNamet from 'react'
      ...
      <ul className="contact-list">
        ...
        <li className="contact-list-item">
          ...
          <div className="wrapper">
            ...
            <a href="mailto:info@jack.com" className="contact-info">info@ss.com</a>

            <a href="mailto:support@jack.com" className="contact-info">support@ss.com</a>
          </div>
